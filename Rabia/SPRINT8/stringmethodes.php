...
if (isset($_POST["submit"])) {
    ...
    //ik voeg hier de volgende  regels van de opdracht toe.
    $naam = trim($naam);
    $straat = trim($straat);
    ...
    //als de plaats amsterdam is dan is de bezorgkosten 10,00, of anders utrecht 20, anders 30.
    ...
    //met echo geef ik aan dat het moet worden uitgeprint, hier dus de mail en naam
    ...
    // Als string lengte postcode niet gelijk is aan 7, dan print hij ''postcode incorrect ingevuld'' in.
    ...
    //nl1br is een Methode van Break. gebruiken we het omzetten van tekst naar hypertekst.
